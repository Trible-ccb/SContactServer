...
public class URLUtil {
	static String USER_AGENT = "Mozilla/5.0 (Windows NT 6.1; WOW64) " +
    ...
    public static void sendPost(String url, JsonObject param) {
    	HttpPost post = new HttpPost(url);
    	post.setEntity(new StringEntity(param.toString(),"UTF-8"));
    	CloseableHttpClient client = HttpClients.createDefault();
    	try {
			CloseableHttpResponse rep = client.execute(post);
