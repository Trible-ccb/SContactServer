...
CREATE TABLE `phone_group_info` (
  ...
  `raw_phone_number_id` bigint(20) unsigned DEFAULT NULL,
  `group_id` bigint(20) unsigned NOT NULL,
  `user_id` bigint(20) unsigned DEFAULT NULL,
  `contact_ids` text COMMENT 'raw phone numbers 的id数组字符串 逗号分隔such as{1,2}',
  PRIMARY KEY (`id`),
  KEY `group_fk` (`group_id`),
  KEY `raw_phone_number_id` (`raw_phone_number_id`),
  CONSTRAINT `group_fk` FOREIGN KEY (`group_id`) REFERENCES `groupsinfo` (`group_id`),
  CONSTRAINT `phone_group_info_ibfk_2` FOREIGN KEY (`raw_phone_number_id`) REFERENCES `raw_phone_numbers` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of phone_group_info
-- ----------------------------
INSERT INTO `phone_group_info` VALUES ('1', null, '3', '4', '[4]');
INSERT INTO `phone_group_info` VALUES ('2', null, '4', '4', '[4]');
INSERT INTO `phone_group_info` VALUES ('3', null, '5', '4', '[4]');
INSERT INTO `phone_group_info` VALUES ('4', null, '6', '5', '[5]');
INSERT INTO `phone_group_info` VALUES ('5', null, '7', '6', '[6]');
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='the table record the relationship between user and his phone numbers.cause'' someone may has many number in real word.';

-- ----------------------------
-- Records of raw_phone_numbers
-- ----------------------------
INSERT INTO `raw_phone_numbers` VALUES ('4', '4', '啊', '0', '1396755230179');
INSERT INTO `raw_phone_numbers` VALUES ('5', '5', '额', '0', '1396756446701');
INSERT INTO `raw_phone_numbers` VALUES ('6', '6', '15882003904', '0', '1396760826337');
INSERT INTO `raw_phone_numbers` VALUES ('7', '7', '吖', '0', '1396760988972');
INSERT INTO `raw_phone_numbers` VALUES ('8', '4', '15882003904', '0', '1397233805436');
INSERT INTO `raw_phone_numbers` VALUES ('9', '4', '02861857754', '0', '1397233864642');
INSERT INTO `raw_phone_numbers` VALUES ('10', '4', '110', '0', '1397233989705');
